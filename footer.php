                              ...
                              <div class="footer__links-content">
                                  <ul class="footer__linklist">
                                      ...
                                      <li class="footer__linklist-item"> <a href="service.php">Our Services</a></li>
                                                                            <li class="footer__linklist-item"> <a href="privacypolicy.php">Privacy Policy</a></li>
                                      <li class="footer__linklist-item"> <a href="termsconditions.php">Terms Conditions</a></li>
                      ...
                      <div class="col-md-2 col-sm-4 col-6">
                          <div class="footer__links">
                              ...
                              <div class="footer__links-content">
                                      ...
                                      <p class="footer__linklist-item" style="margin-left: -7px;
                                       font-size: small;"><i class="fa fa-envelope" aria-hidden="true"></i> &nbsp; support@pemaxx.com</p>
                                      <p class="footer__linklist-item" style=" font-size: small;"><i class="fa fa-globe" aria-hidden="true"></i> &nbsp;<a href="https://www.pemaxx.com">www.pemaxx.com</a></p>
              ...
              <div class="footer__bottom">
                  <div class="footer__end">
                      <div class="footer__end-copyright">
                          <p class=" mb-0">© 2023 All Rights Reserved By <a href="#" target="_blank" rel="noopener">Pemaxx Global Liquidity
                         </a>
                          </p>
                      </div>
                      <div>
