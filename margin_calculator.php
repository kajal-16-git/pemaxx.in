    ...
    <!-- Breadcrumb Start -->
      <section class="breadcrumb mb-0" style="background-image: url(assets/images/bg/bg_1.jpg); background-size: cover; background-position: bottom; height: 30ch;">
        <div class="container pt-5">
          <div class="pt-5"></div>
          <h1 class="fs-2 text-white pt-5 mt-3"> Margin Calculator</h1>
          <nav class="breadcrumb text-light">
            <a class="breadcrumb-item text-light" href="index.php">Home</a>
            <span class="breadcrumb-item active text-light" aria-current="page">Margin Calculator</span>
          </nav>
        </div>
      </section>
    <!-- Breadcrumb End -->
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-8 col-sm-8">
              <div class="card p-4">
                <h1 class="fs-3 mb-3">Margin Calculator</h1>
                <div id="margin-calculator-437752">
                  ...
                  <script type="text/javascript">
                    RemoteCalc({
                      ...
                      "ContainerId": "margin-calculator-437752"
                    });
                  </script>
                </div>
              </div>
